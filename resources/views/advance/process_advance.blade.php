                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Process Advance</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="card">
    <div class="card-header">
        ...
        <a class="btn btn-sm btn-outline-primary float-right mr-1" href="{{route("advance.processed_data_list")}}">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="name">Advance Type</label>
            ...
            <tr>
                <td>
                    ...
                    @else
                        ...
                        <input name="allrows[{{$key}}][advance_id]" type="checkbox" value="{{$advance->id}}" id="allcheck-{{$advance->id}}" checked hidden />
                    @endif
                </td>
                <td>{{ $key+1 }}</td>
