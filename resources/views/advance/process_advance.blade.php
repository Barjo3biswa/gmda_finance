                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="installment_month" id="installment_month"
                                                        ...
                                                        <option value="2"
                                                            {{ old('installment_month') == 2 ? 'selected' : '' }}>February
                                                        </option>
                                                        <option value="3"
                                                        ...
                                                        <option value="9"
                                                            {{ old('installment_month') == 9 ? 'selected' : '' }}>September
                                                        </option>
                                                        <option value="10"
                                                            {{ old('installment_month') == 10 ? 'selected' : '' }}>October
                                                        </option>
                                                        <option value="11"
                                                            {{ old('installment_month') == 11 ? 'selected' : '' }}>November
                                                        </option>
                                                        <option value="12"
                                                            {{ old('installment_month') == 12 ? 'selected' : '' }}>December
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    @forelse ($advances as $key => $advance)
                                                        <tr>
                                                            ...
                                                            <td>{{ optional($advance->employee)->first_name ?? 'N/A' }}
                                                                {{ optional($advance->employee)->last_name ?? 'N/A' }}</td>
