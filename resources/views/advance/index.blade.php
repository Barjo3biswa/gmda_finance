...
<div class="card mt-2">
            <div class="card-header">
                <!-- <a class="btn btn-success btn btn-xs float-right mr-1" href="{{route("advance.create")}}"><i class="fa fa-plus"></i> New Advance</a> | -->
                 <a class="btn btn-success btn btn-xs float-right mr-1" href="{{route("advance.existing")}}"><i class="fa fa-plus"></i> Old Advance</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered table-sm font-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('advance.edit',['id' => $data->id])}}" class="btn btn-success btn-xs">View/Update</a>
                            </td>
                            <td>
                    ...
                    <!-- <tfoot>
                        <tr>
                            ...
                            <th class="text-right">
                                @php
                                    echo number_format((float)$advanceRequests->sum("amount"), 2);
                                @endphp</th>
                            <th class="text-right">
                            @php
                                echo number_format((float)$advanceRequests->sum("monthly_installment"), 2);
                            @endphp
                            </th>
                            <th class="text-right">
                            @php
                                echo number_format((float)$advanceRequests->sum("remaining_amount"), 2);
                            @endphp
                            </th>
                            <th colspan="3"></th>
                        </tr>
