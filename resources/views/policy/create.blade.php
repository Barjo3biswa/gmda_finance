                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{ route('policy.index') }}"
                                        class="btn btn-sm btn-outline-success float-right mr-1">Policy records</a>
                                </div>
                                <div class="card-body">
                        ...
                        @endforeach
                                        ...
                                        <div class="form-group row">
                                            <div class=" col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="policy_no"
                                                    placeholder="policy number" name="policy_no" id="policy_no" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="dependent_name"
                                                    name="dependent_name" placeholder="dependent name" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class=" col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="policy_name"
                                                    name="policy_name" value="LIC" required>
                                            </div>
                                            {{-- <!-- <div class="col-md-6">
                                  ...
                                  <input type="number" class="form-control  text-right" id="amount" name="amount" placeholder="0.00"></textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control  text-right" id="monthly_premium"
                                                    name="monthly_premium" placeholder="0.00" required=""></textarea>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="inputcompany_name">W.E.F. Month</label>
                                                <select name="wef_month" id="wef_month" class="form-control">
                                                    <option value="">Select Month</option>
                                                    <option value="1" {{ old('wef_month') == '1' ? 'selected' : '' }}>
                                                        January</option>
                                                    <option value="2" {{ old('wef_month') == '2' ? 'selected' : '' }}>
                                                        February</option>
                                                    <option value="3" {{ old('wef_month') == '3' ? 'selected' : '' }}>
                                                        March</option>
                                                    <option value="4" {{ old('wef_month') == '4' ? 'selected' : '' }}>
                                                        April</option>
                                                    <option value="5" {{ old('wef_month') == '5' ? 'selected' : '' }}>
                                                        May</option>
                                                    <option value="6" {{ old('wef_month') == '6' ? 'selected' : '' }}>
                                                        June</option>
                                                    <option value="7" {{ old('wef_month') == '7' ? 'selected' : '' }}>
                                                        July</option>
                                                    <option value="8" {{ old('wef_month') == '8' ? 'selected' : '' }}>
                                                        August</option>
                                                    <option value="9" {{ old('wef_month') == '9' ? 'selected' : '' }}>
                                                        September</option>
                                                    <option value="10"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="maturity_date" id="maturity_date"
                                                    class="form-control" placeholder="Maturity Date">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" name="closing_date"
                                                    id="closing_date" placeholder="closing date">
                                            </div>
