                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('loan.index') }}"
                                    class="btn btn-sm btn-outline-success float-right mr-1">Loan records</a>
                            </div>
                            <br>
                            <div class="card-body">
                                <form action="{{ route('loan.update', $loan->id) }}" method="POST">
                                    ...
                                    @method('PUT')
                                    <div class="row">
                                        <input type="hidden" name="loan_id" id=""
                                            value="{{ old('loan_id', $loan->id) }}">
                                        <input type="hidden" name="advances_id" id=""
                                            value="{{ old('advances_id', $loan->id) }}">
                                        <input type="hidden" name="emp_code" id="emp_code"
                                            value="{{ old('emp_code', $loan->emp_code) }}">
                                        <input type="hidden" name="sal_block_id" id="sal_block_id"
                                            value="{{ old('sal_block_id', $loan->sal_block_id) }}">
                        ...
                        @endforeach
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="reference_no" id="reference_no"
                                                class="form-control"
                                                value="{{ old('reference_no', $loan->reference_no) }}" required
                                                readonly>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" name="loan_amount" id="loan_amount"
                                                class="form-control"
                                                value="{{ old('loan_amount', $loan->principal_amount) }}" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="loan_interest_rate">Interest Rate</label>
                                            <input type="number" name="loan_interest_rate" id="loan_interest_rate"
                                                class="form-control" step="0.01"
                                                value="{{ old('loan_interest_rate', $loan->loan_interest_rate) }}"
                                                required>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" class="form-control" id="no_of_installment"
                                                ...
                                                value="{{ old('no_of_installment', $loan->no_of_installment) }}"
                                                onchange="ReducingInt()">
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" class="form-control" id="outstanding_principal"
                                                name="outstanding_principal" step="0.01"
                                                value="{{ old('outstanding_principal', $loan->outstanding_principal) }}"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" class="form-control" id="monthly_emi"
                                                name="monthly_emi" value="{{ old('monthly_emi', $loan->monthly_emi) }}"
                                                step="0.01">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="adj_emi">Adjustable Installment</label>
                                            <input type="number" class="form-control" id="adj_emi" name="adj_emi"
                                                value="{{ old('adj_emi', $loan->adj_emi) }}" step="0.01">
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="interest_amount" id="interest_amount"
                                                ...
                                                value="{{ old('interest_amount', $loan->interest_amount) }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="no_of_installment_interest">No of installment(Interest)</label>
                                            <input type="number" name="no_of_installment_interest"
                                                id="no_of_installment_interest" class="form-control" required
                                                value="{{ old('no_of_installment_interest', $loan->no_of_installment_interest) }}"
                                                onchange="calculatePrincipalAmount();">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="interest_installment">Interest Installment</label>
                                            <input type="number" name="interest_installment" id="interest_installment"
                                                class="form-control" step="0.01" required
                                                value="{{ old('interest_installment', $loan->interest_emi) }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="adj_interest_emi">Adjustable Interest Installment</label>
                                            <input type="number" name="adj_interest_emi" id="adj_interest_emi"
                                                class="form-control" step="0.01" required
                                                value="{{ old('adj_interest_emi', $loan->adj_interest_emi) }}">
                                        </div>
                                        <div class="col-md-3 mt-5">
                                            <label for="outstanding_interest_amount">Outstanding Interest Amount</label>
                                            <input type="number" name="outstanding_interest_amount"
                                                id="outstanding_interest_amount" class="form-control" step="0.01"
                                                required
                                                value="{{ old('outstanding_interest_amount', $loan->outstanding_interest_amount) }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-3 mt-5">
                                            <label for="adj_interest_emi_in">Adjust in(interest)</label>
                                            <select name="adj_interest_emi_in" id="adj_interest_emi_in"
                                                class="form-control">
                                                <option value="">Select</option>
                                                <option value="f" {{ old('adj_interest_emi_in', $loan->adj_interest_emi_in) == 'f' ? 'selected' : '' }}>First
                                                    Installment</option>
                                                <option value="l" {{ old('adj_interest_emi_in', $loan->adj_interest_emi_in) == 'l' ? 'selected' : '' }}>Last
                                                    Installment</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 mt-5">
                                    ...
                                    {{-- <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" id="close_advance" placeholder="close advance"
                                                name="close_advance" value="{{$loan->close_advance}}">
                                                <option value="">--SELECT--</option>
                                                <option value="Permanent" {{ $loan->close_advance == 'Permanent' ?
                                                    'selected' : '' }}>Permanent</option>
                                                <option value="Temporary" {{ $loan->close_advance == 'Temporary' ?
                                                    'selected' : '' }}>Temporary</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="closed_from_month">Close From Month</label>
                                            <select name="closed_from_month" id="closed_from_month"
                                                class="form-control">
                                                <option value="">Select Month</option>
                                                <option value="1" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '1' ? 'selected' : '' }}>January</option>
                                                <option value="2" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '2' ? 'selected' : '' }}>February</option>
                                                <option value="3" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '3' ? 'selected' : '' }}>March</option>
                                                <option value="4" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '4' ? 'selected' : '' }}>April</option>
                                                <option value="5" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '5' ? 'selected' : '' }}>May</option>
                                                <option value="6" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '6' ? 'selected' : '' }}>June</option>
                                                <option value="7" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '7' ? 'selected' : '' }}>July</option>
                                                <option value="8" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '8' ? 'selected' : '' }}>August</option>
                                                <option value="9" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '9' ? 'selected' : '' }}>September</option>
                                                <option value="10" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '10' ? 'selected' : '' }}>October</option>
                                                <option value="11" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '11' ? 'selected' : '' }}>November</option>
                                                <option value="12" {{ old('closed_from_month', $loan->closed_from_month)
                                                    == '12' ? 'selected' : '' }}>December</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <select name="closed_from_year" id="closed_from_year" class="form-control">
                                                <option value="">Select Year</option>
                                                @for ($year = 2024; $year <= 2035; $year++) <option value="{{ $year }}"
                                                    {{ old('closed_from_year', $loan->closed_from_year) == $year ?
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="closed_to_month" id="closed_to_month" class="form-control">
                                                <option value="">Select Month</option>
                                                <option value="1" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '1' ? 'selected' : '' }}>January</option>
                                                <option value="2" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '2' ? 'selected' : '' }}>February</option>
                                                <option value="3" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '3' ? 'selected' : '' }}>March</option>
                                                <option value="4" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '4' ? 'selected' : '' }}>April</option>
                                                <option value="5" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '5' ? 'selected' : '' }}>May</option>
                                                <option value="6" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '6' ? 'selected' : '' }}>June</option>
                                                <option value="7" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '7' ? 'selected' : '' }}>July</option>
                                                <option value="8" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '8' ? 'selected' : '' }}>August</option>
                                                <option value="9" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '9' ? 'selected' : '' }}>September</option>
                                                <option value="10" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '10' ? 'selected' : '' }}>October</option>
                                                <option value="11" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '11' ? 'selected' : '' }}>November</option>
                                                <option value="12" {{ old('closed_to_month', $loan->closed_to_month) ==
                                                    '12' ? 'selected' : '' }}>December</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <select name="closed_to_year" id="closed_to_year" class="form-control">
                                                <option value="">Select Year</option>
                                                @for ($year = 2024; $year <= 2035; $year++) <option value="{{ $year }}"
                                                    {{ old('closed_to_year', $loan->closed_to_year) == $year ?
                                                    'selected' : '' }}>{{ $year }}</option>
                                                    @endfor
                                            </select>
                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <input type="text" id="DispPAmtR" name="DispPAmtR"
                                                                    class="form-control" placeholder="0.00"
                                                                    readonly="true">
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label>Int. Payable</label>
                                                                <input type="text" id="DispRIntP" name="DispRIntP"
                                                                    placeholder="0.00" class="form-control"
                                                                    readonly="true">
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label>Total Payable</label>
                                                                <input type="text" min="0" step="1" id="DispRTotPayable"
                                                                    name="DispRTotPayable" placeholder="0.00"
