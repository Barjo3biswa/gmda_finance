                    ...
                    <div class="product-payment-inner-st">
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="card">
                                ...
                                <br>
                                <div class="card-body">
                                    <form action="{{ route('loan.store-existing') }}" method="POST"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="js-example-basic-multiple form-control" id="employee_id"
                                                    ...
                                                    @foreach ($employees as $key => $emp)
                                                        <option value="{{ $emp->user_id }}">{{ $emp->first_name }}
                                                ...
                                                <select name="loan_head_id" id="loan_head_id" class="form-control" required>
                                                    ...
                                                    @foreach ($advanceTypes as $advanceType)
                                                        <option value="{{ $advanceType->id }}"
                                                            {{ old('loan_head_id') == $advanceType->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="adj_emi_in" id="adj_emi_in" class="form-control">
                                                    <option value="">Select</option>
                                                    <option value="f"
                                                        {{ old('adj_emi_in') == 'f' ? 'selected' : '' }}>First Installment
                                                    </option>
                                                    <option value="l"
                                                        {{ old('adj_emi_in') == 'l' ? 'selected' : '' }}>Last Installment
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" name="interest_amount" id="interest_amount"
                                                    class="form-control" step="0.01" required value="0">
                                            </div>
                                            <div class="col-md-3 mt-5">
                                                <label for="outstanding_interest_amount">Outstanding Interest
                                                    Amount</label>
                                            ...
                                            <div class="col-md-3 mt-5">
                                                ...
                                                <input type="number" name="no_of_installment_interest"
                                                    id="no_of_installment_interest" class="form-control" step="0.01"
                                                    required value="0">
                                            </div>
                                            <div class="col-md-3 mt-5">
                                                <label for="interest_installment">Interest Installment</label>
                                                <input type="number" name="interest_installment"
                                                    id="interest_installment" class="form-control" step="0.01"
                                                    required value="0">
                                            </div>
                                            <div class="col-md-3 mt-5">
                                            ...
                                            <div class="col-md-3 mt-5">
                                                ...
                                                <select name="adj_interest_emi_in" id="adj_interest_emi_in"
                                                    ...
                                                    <option value="">Select</option>
                                                    <option value="f"
                                                        {{ old('adj_interest_emi_in') == 'f' ? 'selected' : '' }}>First
                                                        Installment</option>
                                                    <option value="l"
                                                        {{ old('adj_interest_emi_in') == 'l' ? 'selected' : '' }}>Last
                                                        Installment</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mt-5">
                                                ...
                                                <select name="wef_month" id="wef_month" class="form-control">
                                                    ...
                                                    <option value="1"
                                                        {{ old('wef_month') == '1' ? 'selected' : '' }}>January</option>
                                                    <option value="2"
                                                        {{ old('wef_month') == '2' ? 'selected' : '' }}>February</option>
                                                    <option value="3"
                                                        {{ old('wef_month') == '3' ? 'selected' : '' }}>March</option>
                                                    <option value="4"
                                                        {{ old('wef_month') == '4' ? 'selected' : '' }}>April</option>
                                                    <option value="5"
                                                        {{ old('wef_month') == '5' ? 'selected' : '' }}>May</option>
                                                    <option value="6"
                                                        {{ old('wef_month') == '6' ? 'selected' : '' }}>June</option>
                                                    <option value="7"
                                                        {{ old('wef_month') == '7' ? 'selected' : '' }}>July</option>
                                                    <option value="8"
                                                        {{ old('wef_month') == '8' ? 'selected' : '' }}>August</option>
                                                    <option value="9"
                                                        {{ old('wef_month') == '9' ? 'selected' : '' }}>September</option>
                                                    <option value="10"
                                                        {{ old('wef_month') == '10' ? 'selected' : '' }}>October</option>
                                                    <option value="11"
                                                        {{ old('wef_month') == '11' ? 'selected' : '' }}>November</option>
                                                    <option value="12"
                                                        {{ old('wef_month') == '12' ? 'selected' : '' }}>December</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mt-5">
