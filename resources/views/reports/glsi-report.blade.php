                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">GLSI Report</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="product-payment-inner-st">
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('report.glsiReport') }}" method="GET"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="report_type" id="report_type" class="form-control"
                                                        ...
                                                        <option value="monthly"
                                                            {{ request('report_type') == 'monthly' ? 'selected' : '' }}>
                                                            Monthly Report</option>
                                                        <option value="summary"
                                                            {{ request('report_type') == 'summary' ? 'selected' : '' }}>
                                                    ...
                                                    <select name="appointment_type" id="appointment_type"
                                                        ...
                                                        @foreach ($appointmenttypes as $type)
                                                            <option value="{{ $type->name }}"
                                                                {{ request('appointment_type') == $type->name ? 'selected' : '' }}>
                                                                {{ $type->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            <div class="alert alert-info">
                                                <strong>Total GLSI Amount:</strong>
                                                @if (request('from_month') && request('to_month'))
                                                    {{ number_format($data, 2) }}
                                                    (From
                                                    {{ Carbon::createFromFormat('m', request('from_month'))->monthName }}
                                                    to {{ Carbon::createFromFormat('m', request('to_month'))->monthName }}
                                                    {{ request('year') }})
                                                @else
                                                    {{ number_format($data, 2) }}
                                                    (Year {{ request('year') }})
