                    ...
                    <div class="product-payment-inner-st">
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            ...
                            <div class="product-tab-list tab-pane fade active in" id="description">
                                <div class="row">
                                    @if (\App\Helpers\commonHelper::isPermissionExist('salary_head_create'))
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="review-content-section">
                                                    <form action="{{ route('salary-head-store') }}" method="post"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="pay_head" id="pay_head"
                                                                        class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                                    <label for="name">Salary Deduction (if
                                                                        absent)</label>
                                                                    <input type="checkbox" id="sal_deduct_if_absent"
                                                                        name="sal_deduct_if_absent" value="1"
                                                                        @if (isset($editable)) {{ $editable->sal_deduct_if_absent == 1 ? 'checked' : '' }} @endif>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                                            <input type="number" name="percentage"
                                                                                class="form-control"
                                                                                @if (isset($editable)) value="{{ $editable->percentage }}" @endif>
                                                                        </div>
                                                                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                                            <h6> % of </h6>
                                                                        </div>
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                            <select name="calculation_on[]"
                                                                                id="calculation_on"
                                                    ...
                                                    <tbody>
                                                        @foreach ($salary_head as $hd)
                                                            <tr>
                                                                ...
                                                                <th>{{ $hd->status }}</th>
                                                                <th>
                                                                    @if (\App\Helpers\commonHelper::isPermissionExist('salary_head_update'))
                                                                        <a
