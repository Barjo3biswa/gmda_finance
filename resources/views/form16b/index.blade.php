...
<div class="single-pro-review-area mt-t-30 mg-b-15">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('form16.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="financial_year" id="financial_year" class="form-control" required>
                            ...
                            @php
                                ...
                                for ($i = -1; $i < 3; $i++) {
                                    $startYear = $currentMonth >= 4 ? $currentYear + $i : $currentYear - 1 + $i;
                                    $endYear = $startYear + 1;
                ...
                <button type="submit" class="btn btn-primary btn-sm">Open Form16b</button>
