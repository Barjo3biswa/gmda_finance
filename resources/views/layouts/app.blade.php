...
<body>
    ...
    <div class="all-content-wrapper">
        <div class="navbar-main-container header-top-area">
                                                    ...
                                                    <li style="display: flex"><a
                                                        ...
                                                        @if ($mod->id == auth()->user()->landing_module)
                                                            <a href="javascript:void(0)"><span
                                                                    class="badge badge-success" style="font-size: 9px">
                                                        ...
                                                        @else
                                                            <a href="javascript:void(0)" class="def"
                                                                data-id="{{ $mod->id }}"><span
                                                                    ...
                                                                    style="font-size: 8px">Set default</span></a>
                                                        @endif
                                                    </li>
                                                @else
                                                    <li style="display: flex"><a
            ...
            <div class="header-advance-area" style="margin-top: 0px;">
                <div class="header-top-area1" style="background: #488acd;">
